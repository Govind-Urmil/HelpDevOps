...
describe('tool registry', () => {
  ...
  it('exposes only implemented tools as available', () => expect(availableTools.map((tool) => tool.id)).toEqual(['cron','structured-data','encoding-hash','ipv4-cidr','linux-permissions','git-reference']));
