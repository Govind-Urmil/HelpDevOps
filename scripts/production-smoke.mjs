...
if(!home.text.includes('data-brand-mark'))failures.push('Current brand marker missing.');
...
for(const header of ['content-security-policy','x-content-type-options','referrer-policy','permissions-policy'])if(!home.response.headers.get(header))failures.push(`Missing ${header}.`);
